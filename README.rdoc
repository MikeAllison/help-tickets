...
* Allow technicians to update employee info without requiring a password change - DONE
* Employee show?
* Method to automatically set employee user name
* Assigning tickets to technicians - DONE
...
* Bug with technicians being able to see status dropdown on tickets/edit form - FIXED
...
* Simplify routes.rb with 'collection' or 'member'
