...
* Show updated_at column on closed tickets and label column "Closed"
* Fix nil class bug on ticket show for tickets with no technician_id
* Fix bug where you can close a ticket without assigned it to anyone
